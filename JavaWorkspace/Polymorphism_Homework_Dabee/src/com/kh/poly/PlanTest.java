...
public class PlanTest {
	...
	public static void main(String[] args) {
		...
		printInfo();
		System.out.println(a1.getName() + "\t\t" + a1.flight(distance));
		System.out.println(c1.getName() + "\t\t" + c1.flight(distance));
		System.out.println(fuel + "주유");
		
		printInfo();
//		System.out.println(a1.getName() + "\t\t" + a1.refuel(fuel));
//		System.out.println(c1.getName() + "\t\t" + c1.refuel(fuel));
